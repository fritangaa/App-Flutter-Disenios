        ...
        child: Center(
          child: Builder(
            builder: (BuildContext context) {
              ...
              slideshowModel.bulletPrimario = this.bulletPrimario;
              slideshowModel.bulletSecundario = this.bulletSecundario;
...
class _SlideshowModel with ChangeNotifier {
  ...
  set bulletPrimario(double tamanioBullet) {
    this._bulletPrimario = tamanioBullet;
  }

  double get bulletSecundario => this._bulletSecundario;

  set bulletSecundario(double tamanioBullet) {
    this._bulletSecundario = tamanioBullet;
  }
}
